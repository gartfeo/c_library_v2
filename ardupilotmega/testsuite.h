...
static void mavlink_test_check_in(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_check_in_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_check_in_pack(system_id, component_id, &msg , packet1.sid );
    mavlink_msg_check_in_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_check_in_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.sid );
    mavlink_msg_check_in_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_check_in_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_check_in_send(MAVLINK_COMM_1 , packet1.sid );
    mavlink_msg_check_in_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_check_out(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_check_out_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_check_out_pack(system_id, component_id, &msg , packet1.sid , packet1.lat , packet1.lng , packet1.alt );
    mavlink_msg_check_out_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_check_out_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.sid , packet1.lat , packet1.lng , packet1.alt );
    mavlink_msg_check_out_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_check_out_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_check_out_send(MAVLINK_COMM_1 , packet1.sid , packet1.lat , packet1.lng , packet1.alt );
    mavlink_msg_check_out_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_available_task_request(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_available_task_request_t packet_in = {
        { 17.0, 18.0, 19.0, 20.0, 21.0 },{ 157.0, 158.0, 159.0, 160.0, 161.0 },{ 297.0, 298.0, 299.0, 300.0, 301.0 },{ 20355, 20356, 20357, 20358, 20359 },87,154,{ 221, 222, 223, 224, 225 }
    };
    ...
    mavlink_msg_available_task_request_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_available_task_request_pack(system_id, component_id, &msg , packet1.sid , packet1.count , packet1.task_id , packet1.task_type , packet1.lat , packet1.lng , packet1.alt );
    mavlink_msg_available_task_request_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_available_task_request_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.sid , packet1.count , packet1.task_id , packet1.task_type , packet1.lat , packet1.lng , packet1.alt );
    mavlink_msg_available_task_request_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_available_task_request_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_available_task_request_send(MAVLINK_COMM_1 , packet1.sid , packet1.count , packet1.task_id , packet1.task_type , packet1.lat , packet1.lng , packet1.alt );
    mavlink_msg_available_task_request_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_available_task_response(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_available_task_response_t packet_in = {
        { 17.0, 18.0, 19.0, 20.0, 21.0 },{ 18275, 18276, 18277, 18278, 18279 },223,34,101
    };
    mavlink_available_task_response_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.sid = packet_in.sid;
        packet1.rid = packet_in.rid;
        packet1.count = packet_in.count;
    ...
    mavlink_msg_available_task_response_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_available_task_response_pack(system_id, component_id, &msg , packet1.sid , packet1.rid , packet1.count , packet1.task_id , packet1.time );
    mavlink_msg_available_task_response_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_available_task_response_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.sid , packet1.rid , packet1.count , packet1.task_id , packet1.time );
    mavlink_msg_available_task_response_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_available_task_response_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_available_task_response_send(MAVLINK_COMM_1 , packet1.sid , packet1.rid , packet1.count , packet1.task_id , packet1.time );
    mavlink_msg_available_task_response_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_task_assign_request(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_task_assign_request_t packet_in = {
        17.0,45.0,73.0,17859,175,242,53
    };
    ...
    mavlink_msg_task_assign_request_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_task_assign_request_pack(system_id, component_id, &msg , packet1.sid , packet1.rid , packet1.task_id , packet1.task_type , packet1.lat , packet1.lng , packet1.alt );
    mavlink_msg_task_assign_request_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_task_assign_request_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.sid , packet1.rid , packet1.task_id , packet1.task_type , packet1.lat , packet1.lng , packet1.alt );
    mavlink_msg_task_assign_request_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_task_assign_request_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_task_assign_request_send(MAVLINK_COMM_1 , packet1.sid , packet1.rid , packet1.task_id , packet1.task_type , packet1.lat , packet1.lng , packet1.alt );
    mavlink_msg_task_assign_request_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_task_assign_response(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_task_assign_response_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_task_assign_response_pack(system_id, component_id, &msg , packet1.sid , packet1.rid , packet1.task_id , packet1.accepted );
    mavlink_msg_task_assign_response_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_task_assign_response_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.sid , packet1.rid , packet1.task_id , packet1.accepted );
    mavlink_msg_task_assign_response_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_task_assign_response_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_task_assign_response_send(MAVLINK_COMM_1 , packet1.sid , packet1.rid , packet1.task_id , packet1.accepted );
    mavlink_msg_task_assign_response_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_task_confirm_request(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_task_confirm_request_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_task_confirm_request_pack(system_id, component_id, &msg , packet1.sid , packet1.task_id , packet1.task_type , packet1.lat , packet1.lng , packet1.alt );
    mavlink_msg_task_confirm_request_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_task_confirm_request_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.sid , packet1.task_id , packet1.task_type , packet1.lat , packet1.lng , packet1.alt );
    mavlink_msg_task_confirm_request_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_task_confirm_request_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_task_confirm_request_send(MAVLINK_COMM_1 , packet1.sid , packet1.task_id , packet1.task_type , packet1.lat , packet1.lng , packet1.alt );
    mavlink_msg_task_confirm_request_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_task_confirm_response(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_task_confirm_response_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_task_confirm_response_pack(system_id, component_id, &msg , packet1.rid , packet1.task_id , packet1.confirmed );
    mavlink_msg_task_confirm_response_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_task_confirm_response_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.rid , packet1.task_id , packet1.confirmed );
    mavlink_msg_task_confirm_response_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_task_confirm_response_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_task_confirm_response_send(MAVLINK_COMM_1 , packet1.rid , packet1.task_id , packet1.confirmed );
    mavlink_msg_task_confirm_response_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
