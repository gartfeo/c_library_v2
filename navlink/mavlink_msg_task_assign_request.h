...
#define MAVLINK_MSG_ID_TASK_ASSIGN_REQUEST_LEN 16
#define MAVLINK_MSG_ID_TASK_ASSIGN_REQUEST_MIN_LEN 16
#define MAVLINK_MSG_ID_25106_LEN 16
#define MAVLINK_MSG_ID_25106_MIN_LEN 16

#define MAVLINK_MSG_ID_TASK_ASSIGN_REQUEST_CRC 13
#define MAVLINK_MSG_ID_25106_CRC 13
...
#define MAVLINK_MESSAGE_INFO_TASK_ASSIGN_REQUEST { \
    ...
    "TASK_ASSIGN_REQUEST", \
    6, \
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 14, offsetof(mavlink_task_assign_request_t, target_system) }, \
         { "task_id", NULL, MAVLINK_TYPE_UINT16_T, 0, 12, offsetof(mavlink_task_assign_request_t, task_id) }, \
         { "task_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 15, offsetof(mavlink_task_assign_request_t, task_type) }, \
...
static inline uint16_t mavlink_msg_task_assign_request_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint16_t task_id, uint8_t task_type, float lat, float lng, float alt)
{
...
{
    return mavlink_msg_task_assign_request_pack(system_id, component_id, msg, task_assign_request->target_system, task_assign_request->task_id, task_assign_request->task_type, task_assign_request->lat, task_assign_request->lng, task_assign_request->alt);
}
...
{
    return mavlink_msg_task_assign_request_pack_chan(system_id, component_id, chan, msg, task_assign_request->target_system, task_assign_request->task_id, task_assign_request->task_type, task_assign_request->lat, task_assign_request->lng, task_assign_request->alt);
}
...
{
    return mavlink_msg_task_assign_request_pack_status(system_id, component_id, _status, msg,  task_assign_request->target_system, task_assign_request->task_id, task_assign_request->task_type, task_assign_request->lat, task_assign_request->lng, task_assign_request->alt);
}
...
static inline void mavlink_msg_task_assign_request_send(mavlink_channel_t chan, uint8_t target_system, uint16_t task_id, uint8_t task_type, float lat, float lng, float alt)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_TASK_ASSIGN_REQUEST_LEN];
    _mav_put_float(buf, 0, lat);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_task_assign_request_send(chan, task_assign_request->target_system, task_assign_request->task_id, task_assign_request->task_type, task_assign_request->lat, task_assign_request->lng, task_assign_request->alt);
#else
 ...
 */
static inline void mavlink_msg_task_assign_request_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint16_t task_id, uint8_t task_type, float lat, float lng, float alt)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field target_system from task_assign_request message
 *
 * @return  System ID.
 */
static inline uint8_t mavlink_msg_task_assign_request_get_target_system(const mavlink_message_t* msg)
{
