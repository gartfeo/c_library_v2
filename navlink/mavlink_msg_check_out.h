...
#define MAVLINK_MSG_ID_CHECK_OUT_LEN 12
#define MAVLINK_MSG_ID_CHECK_OUT_MIN_LEN 12
#define MAVLINK_MSG_ID_25003_LEN 12
#define MAVLINK_MSG_ID_25003_MIN_LEN 12

#define MAVLINK_MSG_ID_CHECK_OUT_CRC 158
#define MAVLINK_MSG_ID_25003_CRC 158
...
{
    return mavlink_msg_check_out_pack(system_id, component_id, msg, check_out->lat, check_out->lng, check_out->alt);
}
...
{
    return mavlink_msg_check_out_pack_chan(system_id, component_id, chan, msg, check_out->lat, check_out->lng, check_out->alt);
}
...
{
    return mavlink_msg_check_out_pack_status(system_id, component_id, _status, msg,  check_out->lat, check_out->lng, check_out->alt);
}
...
static inline void mavlink_msg_check_out_send(mavlink_channel_t chan, float lat, float lng, float alt)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_CHECK_OUT_LEN];
    _mav_put_float(buf, 0, lat);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_check_out_send(chan, check_out->lat, check_out->lng, check_out->alt);
#else
 ...
 */
static inline void mavlink_msg_check_out_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float lat, float lng, float alt)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
