...
#define MAVLINK_MSG_ID_AVAILABLE_TASK_REQUEST_LEN 76
#define MAVLINK_MSG_ID_AVAILABLE_TASK_REQUEST_MIN_LEN 76
#define MAVLINK_MSG_ID_25104_LEN 76
#define MAVLINK_MSG_ID_25104_MIN_LEN 76

#define MAVLINK_MSG_ID_AVAILABLE_TASK_REQUEST_CRC 106
#define MAVLINK_MSG_ID_25104_CRC 106
...
#define MAVLINK_MESSAGE_INFO_AVAILABLE_TASK_REQUEST { \
    ...
    6, \
    {  { "count", NULL, MAVLINK_TYPE_UINT8_T, 0, 70, offsetof(mavlink_available_task_request_t, count) }, \
         { "task_id", NULL, MAVLINK_TYPE_UINT16_T, 5, 60, offsetof(mavlink_available_task_request_t, task_id) }, \
         { "task_type", NULL, MAVLINK_TYPE_UINT8_T, 5, 71, offsetof(mavlink_available_task_request_t, task_type) }, \
...
static inline uint16_t mavlink_msg_available_task_request_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t count, const uint16_t *task_id, const uint8_t *task_type, const float *lat, const float *lng, const float *alt)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_AVAILABLE_TASK_REQUEST_LEN];
    _mav_put_uint8_t(buf, 70, count);
    ...
    _mav_put_uint8_t_array(buf, 71, task_type, 5);
...
{
    return mavlink_msg_available_task_request_pack(system_id, component_id, msg, available_task_request->count, available_task_request->task_id, available_task_request->task_type, available_task_request->lat, available_task_request->lng, available_task_request->alt);
}
...
{
    return mavlink_msg_available_task_request_pack_chan(system_id, component_id, chan, msg, available_task_request->count, available_task_request->task_id, available_task_request->task_type, available_task_request->lat, available_task_request->lng, available_task_request->alt);
}
...
{
    return mavlink_msg_available_task_request_pack_status(system_id, component_id, _status, msg,  available_task_request->count, available_task_request->task_id, available_task_request->task_type, available_task_request->lat, available_task_request->lng, available_task_request->alt);
}
...
static inline void mavlink_msg_available_task_request_send(mavlink_channel_t chan, uint8_t count, const uint16_t *task_id, const uint8_t *task_type, const float *lat, const float *lng, const float *alt)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_AVAILABLE_TASK_REQUEST_LEN];
    _mav_put_uint8_t(buf, 70, count);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_available_task_request_send(chan, available_task_request->count, available_task_request->task_id, available_task_request->task_type, available_task_request->lat, available_task_request->lng, available_task_request->alt);
#else
 ...
 */
static inline void mavlink_msg_available_task_request_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t count, const uint16_t *task_id, const uint8_t *task_type, const float *lat, const float *lng, const float *alt)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
{
    return _MAV_RETURN_uint8_t_array(msg, task_type, 5,  71);
}
