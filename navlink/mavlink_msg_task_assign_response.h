...
#define MAVLINK_MSG_ID_TASK_ASSIGN_RESPONSE_LEN 4
#define MAVLINK_MSG_ID_TASK_ASSIGN_RESPONSE_MIN_LEN 4
#define MAVLINK_MSG_ID_25107_LEN 4
#define MAVLINK_MSG_ID_25107_MIN_LEN 4

#define MAVLINK_MSG_ID_TASK_ASSIGN_RESPONSE_CRC 194
#define MAVLINK_MSG_ID_25107_CRC 194
...
#define MAVLINK_MESSAGE_INFO_TASK_ASSIGN_RESPONSE { \
    ...
    3, \
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_task_assign_response_t, target_system) }, \
         { "task_id", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_task_assign_response_t, task_id) }, \
         { "accepted", NULL, MAVLINK_TYPE_UINT8_T, 0, 3, offsetof(mavlink_task_assign_response_t, accepted) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_TASK_ASSIGN_RESPONSE { \
...
{
    return mavlink_msg_task_assign_response_pack(system_id, component_id, msg, task_assign_response->target_system, task_assign_response->task_id, task_assign_response->accepted);
}
...
{
    return mavlink_msg_task_assign_response_pack_chan(system_id, component_id, chan, msg, task_assign_response->target_system, task_assign_response->task_id, task_assign_response->accepted);
}
...
{
    return mavlink_msg_task_assign_response_pack_status(system_id, component_id, _status, msg,  task_assign_response->target_system, task_assign_response->task_id, task_assign_response->accepted);
}
...
static inline void mavlink_msg_task_assign_response_send(mavlink_channel_t chan, uint8_t target_system, uint16_t task_id, uint8_t accepted)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_TASK_ASSIGN_RESPONSE_LEN];
    _mav_put_uint16_t(buf, 0, task_id);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_task_assign_response_send(chan, task_assign_response->target_system, task_assign_response->task_id, task_assign_response->accepted);
#else
 ...
 */
static inline void mavlink_msg_task_assign_response_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint16_t task_id, uint8_t accepted)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
