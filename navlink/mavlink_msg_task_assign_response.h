...
typedef struct __mavlink_task_assign_response_t {
 ...
 uint16_t task_id; /*<  Task ID being responded to.*/
 uint8_t target_system; /*<  Target system ID (assigner).*/
 uint8_t accepted; /*<  1 if accepted, 0 if rejected.*/
} mavlink_task_assign_response_t;

#define MAVLINK_MSG_ID_TASK_ASSIGN_RESPONSE_LEN 24
#define MAVLINK_MSG_ID_TASK_ASSIGN_RESPONSE_MIN_LEN 24
#define MAVLINK_MSG_ID_25107_LEN 24
#define MAVLINK_MSG_ID_25107_MIN_LEN 24

#define MAVLINK_MSG_ID_TASK_ASSIGN_RESPONSE_CRC 119
#define MAVLINK_MSG_ID_25107_CRC 119
...
#define MAVLINK_MESSAGE_INFO_TASK_ASSIGN_RESPONSE { \
    ...
    7, \
    {  { "boot_id", NULL, MAVLINK_TYPE_UINT32_T, 0, 8, offsetof(mavlink_task_assign_response_t, boot_id) }, \
         { "msg_seq", NULL, MAVLINK_TYPE_UINT32_T, 0, 12, offsetof(mavlink_task_assign_response_t, msg_seq) }, \
         { "time_ms", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_task_assign_response_t, time_ms) }, \
         { "ttl_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 16, offsetof(mavlink_task_assign_response_t, ttl_ms) }, \
         { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 22, offsetof(mavlink_task_assign_response_t, target_system) }, \
         { "task_id", NULL, MAVLINK_TYPE_UINT16_T, 0, 20, offsetof(mavlink_task_assign_response_t, task_id) }, \
         { "accepted", NULL, MAVLINK_TYPE_UINT8_T, 0, 23, offsetof(mavlink_task_assign_response_t, accepted) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_TASK_ASSIGN_RESPONSE { \
 ...
 * @param target_system  Target system ID (assigner).
 * @param task_id  Task ID being responded to.
...
static inline uint16_t mavlink_msg_task_assign_response_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint32_t boot_id, uint32_t msg_seq, uint64_t time_ms, uint32_t ttl_ms, uint8_t target_system, uint16_t task_id, uint8_t accepted)
{
    ...
    _mav_put_uint8_t(buf, 23, accepted);
...
{
    return mavlink_msg_task_assign_response_pack(system_id, component_id, msg, task_assign_response->boot_id, task_assign_response->msg_seq, task_assign_response->time_ms, task_assign_response->ttl_ms, task_assign_response->target_system, task_assign_response->task_id, task_assign_response->accepted);
}
...
{
    return mavlink_msg_task_assign_response_pack_chan(system_id, component_id, chan, msg, task_assign_response->boot_id, task_assign_response->msg_seq, task_assign_response->time_ms, task_assign_response->ttl_ms, task_assign_response->target_system, task_assign_response->task_id, task_assign_response->accepted);
}
...
{
    return mavlink_msg_task_assign_response_pack_status(system_id, component_id, _status, msg,  task_assign_response->boot_id, task_assign_response->msg_seq, task_assign_response->time_ms, task_assign_response->ttl_ms, task_assign_response->target_system, task_assign_response->task_id, task_assign_response->accepted);
}
...
static inline void mavlink_msg_task_assign_response_send(mavlink_channel_t chan, uint32_t boot_id, uint32_t msg_seq, uint64_t time_ms, uint32_t ttl_ms, uint8_t target_system, uint16_t task_id, uint8_t accepted)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_TASK_ASSIGN_RESPONSE_LEN];
    _mav_put_uint64_t(buf, 0, time_ms);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_task_assign_response_send(chan, task_assign_response->boot_id, task_assign_response->msg_seq, task_assign_response->time_ms, task_assign_response->ttl_ms, task_assign_response->target_system, task_assign_response->task_id, task_assign_response->accepted);
#else
 ...
 */
static inline void mavlink_msg_task_assign_response_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t boot_id, uint32_t msg_seq, uint64_t time_ms, uint32_t ttl_ms, uint8_t target_system, uint16_t task_id, uint8_t accepted)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field boot_id from task_assign_response message
 *
 * @return  Random ID generated on process start, identifies sender instance.
 */
static inline uint32_t mavlink_msg_task_assign_response_get_boot_id(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint32_t(msg,  8);
}

/**
 * @brief Get field msg_seq from task_assign_response message
 *
 * @return  Monotonic sequence counter per sender.
 */
static inline uint32_t mavlink_msg_task_assign_response_get_msg_seq(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint32_t(msg,  12);
}

/**
 * @brief Get field time_ms from task_assign_response message
 *
 * @return [ms] Sender timestamp in milliseconds since epoch.
 */
static inline uint64_t mavlink_msg_task_assign_response_get_time_ms(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint64_t(msg,  0);
}

/**
 * @brief Get field ttl_ms from task_assign_response message
 *
 * @return [ms] Time-to-live validity window in milliseconds.
 */
static inline uint32_t mavlink_msg_task_assign_response_get_ttl_ms(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint32_t(msg,  16);
}

/**
 * @brief Get field target_system from task_assign_response message
 *
 * @return  Target system ID (assigner).
 */
static inline uint8_t mavlink_msg_task_assign_response_get_target_system(const mavlink_message_t* msg)
{
 ...
 *
 * @return  Task ID being responded to.
 */
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    task_assign_response->time_ms = mavlink_msg_task_assign_response_get_time_ms(msg);
    task_assign_response->boot_id = mavlink_msg_task_assign_response_get_boot_id(msg);
    task_assign_response->msg_seq = mavlink_msg_task_assign_response_get_msg_seq(msg);
    task_assign_response->ttl_ms = mavlink_msg_task_assign_response_get_ttl_ms(msg);
    task_assign_response->task_id = mavlink_msg_task_assign_response_get_task_id(msg);
    task_assign_response->target_system = mavlink_msg_task_assign_response_get_target_system(msg);
